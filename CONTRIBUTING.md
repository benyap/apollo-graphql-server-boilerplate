# Contributing to apollo-graphql-server-boilerplate
...
The [issue tracker](https://github.com/bwyap/apollo-graphql-server-boilerplate/issues) is
...
owners to license your work under the terms of the [MIT License](https://github.com/bwyap/apollo-graphql-server-boilerplate/blob/master/LICENSE.md).
